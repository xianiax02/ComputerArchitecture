...
module tb_Memory;
	...
	initial begin
		ALUresult_in = 0;
		#25 ALUresult_in = 'hc+'d12;	//[x3+12] = 24
		#10 ALUresult_in = 'h8+'d8;	//[x2+8] = 16
		#10 ALUresult_in = 'h4+'d4;	//[x1+4] = 8
		#10 ALUresult_in = 'hc+'d12;
		#10 ALUresult_in = 'h8+'d8;
		#10 ALUresult_in = 'h4+'d4;
		#10 ALUresult_in = 0;
		#10 ALUresult_in = 0;
		#10 ALUresult_in = 0;
	end
